...
# ---- Prediction Function ----
def predict_image(image_path, swin, gnn_stage, confidence_threshold=0.1):
    transform = transforms.Compose([
        transforms.Resize((64, 64)),
        transforms.ToTensor(),
    ])
    ...
    with torch.no_grad():
        ...
        if max_prob.item() < confidence_threshold:
            return "No cancer detected or image is invalid"

    idx_to_stage = {0: 'Pro', 1: 'Pre', 2: 'Early', 3: 'Beginning'}
    return idx_to_stage[predicted_class.item()]
...
#"C:Users\aditi\Downloads\archive\traning\WBC-Malignant-Pro-793.jpg" C:\Users\aditi\Downloads\archive\traning\WBC-Benign-490.jpg
    test_image_path = r"C:\Users\aditi\Downloads\archive\traning\WBC-Malignant-Pre-956.jpg"
    prediction = predict_image(test_image_path, swin_model, gnn_model)
    print(f"Predicted Leukemia Stage: {prediction}")

#"C:\Users\aditi\Downloads\archive\traning\WBC-Benign-495.jpg"C:\Users\aditi\Downloads\archive\traning\WBC-Malignant-Early-971.jpg
